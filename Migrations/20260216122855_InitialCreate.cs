        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectValue = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentApprover = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                    Comments = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ResolutionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ResolvedBy = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                    ResolutionComments = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApprovalWorkflows", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApprovalWorkflows_AspNetUsers_CurrentApprover",
                        column: x => x.CurrentApprover,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApprovalWorkflows_AspNetUsers_RequestedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApprovalHistory_ApprovalWorkflows_WorkflowId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalWorkflows_CurrentApprover",
                table: "ApprovalWorkflows",
                column: "CurrentApprover");

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalWorkflows_CurrentStatus",
                table: "ApprovalWorkflows",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PageViews_PageUrl",
                table: "PageViews",
                column: "PageUrl");

            migrationBuilder.CreateIndex(
                name: "IX_PageViews_ViewDate",
                table: "PageViews",
                column: "ViewDate");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceInquiries_Status",
                table: "ServiceInquiries",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_Services_ApprovalStatus",
                table: "Services",
                column: "ApprovalStatus");
